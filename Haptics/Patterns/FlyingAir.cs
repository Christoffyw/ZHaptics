...
namespace ZHaptics.Haptics.Patterns
{
    public class FlyingAir
    {
        ...
        private static Transform positionRef;
        ...
        public static RaycastHit? GetFlyingHeight()
        {
            ...
            var hitItem = Physics.Raycast(positionRef.position, -Vector3.up, out hit);
        ...
        public static void Init(Transform positionRef)
        {
            FlyingAir.positionRef = positionRef;
        }
