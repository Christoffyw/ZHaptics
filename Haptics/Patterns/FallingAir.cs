...
namespace ZHaptics.Haptics.Patterns
{
    public class FallingAir
    {
        ...
        private static ZenithGravityProvider _gravityProvider;
        ...
        public static void Execute(bool wasFlying)
        {
            ...
            var absVelocity = Mathf.Abs(_gravityProvider.velocity.y);
        ...
        public static void Init(ZenithGravityProvider provider)
        {
            _gravityProvider = provider;
        }
    }
}