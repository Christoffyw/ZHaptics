...
namespace ZHaptics.Haptics.EffectManagers
{
    public class EffectLoopRegistry
    {
        ...
        private static void Play(string key, EffectTimingData effect, uint time)
        {
            ...
            Plugin.Instance.Haptics.Player.Submit(key, effect.Effect.Position, effect.Current.State, (int)effect.Current.Length);
