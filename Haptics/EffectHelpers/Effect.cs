...
namespace ZHaptics.Haptics.EffectHelpers
{
    public class Effect
    {
        ...
        public void Stop()
        {
            ...
            {
                Plugin.Instance.Haptics.Player.TurnOff(activeEffect.ToString());
        ...
        private void ResizePool(bool force = false)
        {
            ...
            for (uint i = 0; i < toAdd; i++)
            {
                ...
                Plugin.Instance.Haptics.Player.Register(id.ToString(), Contents);
            }
        ...
        private void SubmitEffect(System.Guid id, EffectProperties properties)
        {
            ...
            Plugin.Instance.Haptics.Player.SubmitRegisteredVestRotation(
                id.ToString(), 
                id.ToString(), 
